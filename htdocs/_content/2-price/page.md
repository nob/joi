...
ならば、単に制作したウェブサイトをあなたに**納品する**だけではなく、月額一律料金の**サービス**としてご提供するのがあなたにとって最適だと考えます。
...
ジョインタネットが提供するサービスにおいて、お客様との密なコミュニケーションは重要な部分ですが、遠距離のお客様の元への頻繁な出張が発生致しますと別途、交通費が掛かってしまいます。ご了承下さい。
各種サポートやアドバイス等は、可能な限り、Emailや音声/ビデオ通話でのミーティングやコミュニケーションとなります。ご協力頂きます様、宜しく御願い致します。
