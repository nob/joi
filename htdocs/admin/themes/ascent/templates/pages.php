<div id="subnav">
  <ul>
    <li><a href="<?php echo $app->urlFor("pages"); ?>" class="active">Pages</a></li>
...
<div class="container">
  ...
  <div id="status-bar">
    <div class="status-block">
      <span class="muted">Viewing all </span>
    ...
    <ul>
      <li>
        <a href="#" class="add-page-btn" data-path="/" data-title="None">
        ...
        <div class="page-wrapper">
          ...
          <div class="page-extras">
            ...
            ?>
              <div class="page-view"><a href="<?php print $page['url'] ?>" class="tip" title="View Page"><span class="ss-icon">link</span></a></div>
              <div class="page-add">
                <a href="#" data-path="<?php print $folder; ?>" data-title="<?php print $page['title']?>" class="tip add-page-btn" title="<?php echo Localization::fetch('new_child_page')?>"><span class="ss-icon">addfile</span></a>
              </div>
              <?php if (Config::get('_enable_delete_page', true)):?>
                <div class="page-delete">
                  <a class="confirm" href="<?php print $app->urlFor('delete_page') . '?path=' . $page['raw_url'] . '&type=' . $page['type']?>" class="tip" title="<?php echo Localization::fetch('delete_page')?>" data-confirm-message="Are you sure you wish to delete this page?">
  ...
  <li class="page">
    <div class="page-wrapper">
      ...
      <div class="page-extras">
        ...
        <?php if ($page['type'] != 'file'): ?>
        <div class="page-add"><a href="#" data-path="<?php print $page['raw_url']?>" data-title="<?php print $page['title']?>" class="tip add-page-btn" title="<?php echo Localization::fetch('new_child_page')?>"><span class="ss-icon">addfile</span></a></div>
        <?php endif; ?>
